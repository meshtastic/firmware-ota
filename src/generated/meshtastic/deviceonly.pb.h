...
Indicates developer is testing and changes should never be saved to flash. */
  bool no_save;
  /* Some GPS receivers seem to have bogus settings from the factory, so we
   * always do one factory reset. */
  bool did_gps_reset;
...
#define _meshtastic_ScreenFonts_ARRAYSIZE                                      \
  ((meshtastic_ScreenFonts)(meshtastic_ScreenFonts_FONT_LARGE + 1))
...
#define meshtastic_DeviceState_init_default                                    \
  {                                                                            \
    false, meshtastic_MyNodeInfo_init_default, false,                          \
        meshtastic_User_init_default, 0,                                       \
        {meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         ...
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default,   \
         meshtastic_NodeInfo_init_default, meshtastic_NodeInfo_init_default},  \
        0, {meshtastic_MeshPacket_init_default}, false,                        \
        meshtastic_MeshPacket_init_default, 0, 0, 0                            \
  }
#define meshtastic_ChannelFile_init_default                                    \
  {                                                                            \
    0, {meshtastic_Channel_init_default, meshtastic_Channel_init_default,      \
...
#define meshtastic_OEMStore_init_default                                       \
  {                                                                            \
    0, 0, {0, {0}}, _meshtastic_ScreenFonts_MIN, "", {0, {0}}, false,          \
        meshtastic_LocalConfig_init_default, false,                            \
        meshtastic_LocalModuleConfig_init_default                              \
  }
#define meshtastic_DeviceState_init_zero                                       \
  {                                                                            \
    false, meshtastic_MyNodeInfo_init_zero, false, meshtastic_User_init_zero,  \
        0, {meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            ...
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero,      \
            meshtastic_NodeInfo_init_zero, meshtastic_NodeInfo_init_zero},     \
        0, {meshtastic_MeshPacket_init_zero}, false,                           \
        meshtastic_MeshPacket_init_zero, 0, 0, 0                               \
  }
#define meshtastic_ChannelFile_init_zero                                       \
  {                                                                            \
    0, {meshtastic_Channel_init_zero, meshtastic_Channel_init_zero,            \
...
#define meshtastic_OEMStore_init_zero                                          \
  {                                                                            \
    0, 0, {0, {0}}, _meshtastic_ScreenFonts_MIN, "", {0, {0}}, false,          \
        meshtastic_LocalConfig_init_zero, false,                               \
...
#define meshtastic_OEMStore_oem_local_module_config_MSGTYPE                    \
