...
/* Struct definitions */
/* This message wraps a MeshPacket with extra metadata about the sender and how
 * it arrived. */
...
nodeid impersonation for senders? - i.e. use gateway/mesh id (which is
authenticated) + local node id as the globally trusted nodenum */
  char *gateway_id;
