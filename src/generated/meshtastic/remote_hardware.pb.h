...
Will implicitly change the gpios requested to be INPUT gpios. */
  ...
  /* The gpios listed in gpio_mask have changed, the new values are listed in
     gpio_value */
  meshtastic_HardwareMessage_Type_GPIOS_CHANGED = 3,
  /* Read the gpios specified in gpio_mask, send back a READ_GPIOS_REPLY reply
     with gpio_value populated */
...
/* An example app to show off the module system. This message is used for
 ...
 In the future other remote hardware operations can be added based on user
 interest (i.e. serial output, spi/i2c input/output).
...
typedef struct _meshtastic_HardwareMessage {
  ...
  /* What gpios are we changing. Not used for all MessageTypes, see MessageType
   * for details */
  uint64_t gpio_mask;
  /* For gpios that were listed in gpio_mask as valid, what are the signal
levels for those gpios. Not used for all MessageTypes, see MessageType for
details */
  uint64_t gpio_value;
...
#define _meshtastic_HardwareMessage_Type_MIN                                   \
