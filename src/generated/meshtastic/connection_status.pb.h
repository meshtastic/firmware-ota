...
#define meshtastic_DeviceConnectionStatus_init_default                         \
  {                                                                            \
    false, meshtastic_WifiConnectionStatus_init_default, false,                \
        meshtastic_EthernetConnectionStatus_init_default, false,               \
        meshtastic_BluetoothConnectionStatus_init_default, false,              \
        meshtastic_SerialConnectionStatus_init_default                         \
  }
...
#define meshtastic_DeviceConnectionStatus_init_zero                            \
  {                                                                            \
    false, meshtastic_WifiConnectionStatus_init_zero, false,                   \
        meshtastic_EthernetConnectionStatus_init_zero, false,                  \
        meshtastic_BluetoothConnectionStatus_init_zero, false,                 \
        meshtastic_SerialConnectionStatus_init_zero                            \
  }
...
#define meshtastic_DeviceConnectionStatus_wifi_MSGTYPE                         \
  meshtastic_WifiConnectionStatus
#define meshtastic_DeviceConnectionStatus_ethernet_MSGTYPE                     \
  meshtastic_EthernetConnectionStatus
#define meshtastic_DeviceConnectionStatus_bluetooth_MSGTYPE                    \
  meshtastic_BluetoothConnectionStatus
#define meshtastic_DeviceConnectionStatus_serial_MSGTYPE                       \
  meshtastic_SerialConnectionStatus
...
#define meshtastic_WifiConnectionStatus_status_MSGTYPE                         \
  meshtastic_NetworkConnectionStatus
...
#define meshtastic_EthernetConnectionStatus_status_MSGTYPE                     \
  meshtastic_NetworkConnectionStatus
...
#define meshtastic_DeviceConnectionStatus_fields                               \
  &meshtastic_DeviceConnectionStatus_msg
#define meshtastic_WifiConnectionStatus_fields                                 \
  &meshtastic_WifiConnectionStatus_msg
#define meshtastic_EthernetConnectionStatus_fields                             \
  &meshtastic_EthernetConnectionStatus_msg
#define meshtastic_NetworkConnectionStatus_fields                              \
  &meshtastic_NetworkConnectionStatus_msg
#define meshtastic_BluetoothConnectionStatus_fields                            \
  &meshtastic_BluetoothConnectionStatus_msg
#define meshtastic_SerialConnectionStatus_fields                               \
  &meshtastic_SerialConnectionStatus_msg
