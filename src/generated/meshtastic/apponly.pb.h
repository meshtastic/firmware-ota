...
/* This is the most compact possible representation for a set of channels.
 ...
 This abstraction is used only on the the 'app side' of the world (ie python,
 javascript and android etc) to show a group of Channels as a (long) URL */
...
#define meshtastic_ChannelSet_init_default                                     \
  {                                                                            \
    0,                                                                         \
        {meshtastic_ChannelSettings_init_default,                              \
         meshtastic_ChannelSettings_init_default,                              \
         meshtastic_ChannelSettings_init_default,                              \
         meshtastic_ChannelSettings_init_default,                              \
         meshtastic_ChannelSettings_init_default,                              \
...
#define meshtastic_ChannelSet_init_zero                                        \
  {                                                                            \
    0, {meshtastic_ChannelSettings_init_zero,                                  \
        meshtastic_ChannelSettings_init_zero,                                  \
        meshtastic_ChannelSettings_init_zero,                                  \
        meshtastic_ChannelSettings_init_zero,                                  \
        meshtastic_ChannelSettings_init_zero,                                  \
        meshtastic_ChannelSettings_init_zero,                                  \
