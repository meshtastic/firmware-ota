...
PB_BIND(meshtastic_Config_PositionConfig, meshtastic_Config_PositionConfig,
        AUTO)
...
PB_BIND(meshtastic_Config_NetworkConfig_IpV4Config,
        meshtastic_Config_NetworkConfig_IpV4Config, AUTO)
...
PB_BIND(meshtastic_Config_BluetoothConfig, meshtastic_Config_BluetoothConfig,
        AUTO)
