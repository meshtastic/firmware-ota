...
typedef struct _meshtastic_ModuleConfig_MQTTConfig {
  /* If a meshtastic node is able to reach the internet it will normally attempt
to gateway any channels that are marked as is_uplink_enabled or
is_downlink_enabled. */
  bool enabled;
...
If using the default server, this will only be honoured if set, otherwise the
device will use the default username */
  char username[64];
  /* MQTT password to use (most useful for a custom MQTT server).
If using a custom server, this will be honoured even if empty.
If using the default server, this will only be honoured if set, otherwise the
device will use the default password */
  char password[64];
  /* Whether to send encrypted or decrypted packets to MQTT.
This parameter is only honoured if you also set server
(the default official mqtt.meshtastic.org server can handle encrypted packets)
Decrypted packets may be useful for external systems that want to consume
meshtastic packets */
...
FIXME - Move this out of UserPreferences and into a section for module
configuration. */
  bool enabled;
  /* TODO: REPLACE */
  bool echo;
...
#define _meshtastic_ModuleConfig_AudioConfig_Audio_Baud_MIN                    \
  meshtastic_ModuleConfig_AudioConfig_Audio_Baud_CODEC2_DEFAULT
#define _meshtastic_ModuleConfig_AudioConfig_Audio_Baud_MAX                    \
  meshtastic_ModuleConfig_AudioConfig_Audio_Baud_CODEC2_700B
...
#define _meshtastic_ModuleConfig_SerialConfig_Serial_Baud_MIN                  \
  meshtastic_ModuleConfig_SerialConfig_Serial_Baud_BAUD_DEFAULT
...
#define _meshtastic_ModuleConfig_SerialConfig_Serial_Baud_ARRAYSIZE                                                  \
  ((meshtastic_ModuleConfig_SerialConfig_Serial_Baud)(meshtastic_ModuleConfig_SerialConfig_Serial_Baud_BAUD_921600 + \
                                                      1))

#define _meshtastic_ModuleConfig_SerialConfig_Serial_Mode_MIN                  \
  meshtastic_ModuleConfig_SerialConfig_Serial_Mode_DEFAULT
#define _meshtastic_ModuleConfig_SerialConfig_Serial_Mode_MAX                  \
  meshtastic_ModuleConfig_SerialConfig_Serial_Mode_NMEA
#define _meshtastic_ModuleConfig_SerialConfig_Serial_Mode_ARRAYSIZE                                           \
  ((meshtastic_ModuleConfig_SerialConfig_Serial_Mode)(meshtastic_ModuleConfig_SerialConfig_Serial_Mode_NMEA + \
                                                      1))
...
#define meshtastic_ModuleConfig_AudioConfig_bitrate_ENUMTYPE                   \
  meshtastic_ModuleConfig_AudioConfig_Audio_Baud

#define meshtastic_ModuleConfig_SerialConfig_baud_ENUMTYPE                     \
  meshtastic_ModuleConfig_SerialConfig_Serial_Baud
#define meshtastic_ModuleConfig_SerialConfig_mode_ENUMTYPE                     \
  meshtastic_ModuleConfig_SerialConfig_Serial_Mode
...
#define meshtastic_ModuleConfig_SerialConfig_init_default                      \
  {                                                                            \
    0, 0, 0, 0, _meshtastic_ModuleConfig_SerialConfig_Serial_Baud_MIN, 0,      \
        _meshtastic_ModuleConfig_SerialConfig_Serial_Mode_MIN                  \
  }
...
#define meshtastic_ModuleConfig_CannedMessageConfig_init_default               \
  {                                                                            \
    0, 0, 0, 0,                                                                \
        ...
        _meshtastic_ModuleConfig_CannedMessageConfig_InputEventChar_MIN,       \
        _meshtastic_ModuleConfig_CannedMessageConfig_InputEventChar_MIN, 0, 0, \
        "", 0                                                                  \
  }
...
#define meshtastic_ModuleConfig_ExternalNotificationConfig_alert_message_vibra_tag \
  10
#define meshtastic_ModuleConfig_ExternalNotificationConfig_alert_message_buzzer_tag \
  11
#define meshtastic_ModuleConfig_ExternalNotificationConfig_alert_bell_vibra_tag \
  12
#define meshtastic_ModuleConfig_ExternalNotificationConfig_alert_bell_buzzer_tag \
  13
...
#define meshtastic_ModuleConfig_TelemetryConfig_environment_update_interval_tag \
  2
#define meshtastic_ModuleConfig_TelemetryConfig_environment_measurement_enabled_tag \
  3
#define meshtastic_ModuleConfig_TelemetryConfig_environment_screen_enabled_tag 4
#define meshtastic_ModuleConfig_TelemetryConfig_environment_display_fahrenheit_tag \
  5
...
#define meshtastic_ModuleConfig_CannedMessageConfig_inputbroker_event_press_tag \
  7
...
#define meshtastic_ModuleConfig_FIELDLIST(X, a)                                \
  X(a, STATIC, ONEOF, MESSAGE, (payload_variant, mqtt, payload_variant.mqtt),  \
    1)                                                                         \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, serial, payload_variant.serial), 2)                      \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, external_notification,                                   \
     payload_variant.external_notification),                                   \
    3)                                                                         \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, store_forward, payload_variant.store_forward), 4)        \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, range_test, payload_variant.range_test), 5)              \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, telemetry, payload_variant.telemetry), 6)                \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, canned_message, payload_variant.canned_message), 7)      \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, audio, payload_variant.audio), 8)                        \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (payload_variant, remote_hardware, payload_variant.remote_hardware), 9)
#define meshtastic_ModuleConfig_CALLBACK NULL
#define meshtastic_ModuleConfig_DEFAULT NULL
#define meshtastic_ModuleConfig_payload_variant_mqtt_MSGTYPE                   \
  meshtastic_ModuleConfig_MQTTConfig
#define meshtastic_ModuleConfig_payload_variant_serial_MSGTYPE                 \
  meshtastic_ModuleConfig_SerialConfig
#define meshtastic_ModuleConfig_payload_variant_external_notification_MSGTYPE  \
  meshtastic_ModuleConfig_ExternalNotificationConfig
#define meshtastic_ModuleConfig_payload_variant_store_forward_MSGTYPE          \
  meshtastic_ModuleConfig_StoreForwardConfig
#define meshtastic_ModuleConfig_payload_variant_range_test_MSGTYPE             \
  meshtastic_ModuleConfig_RangeTestConfig
#define meshtastic_ModuleConfig_payload_variant_telemetry_MSGTYPE              \
  meshtastic_ModuleConfig_TelemetryConfig
#define meshtastic_ModuleConfig_payload_variant_canned_message_MSGTYPE         \
  meshtastic_ModuleConfig_CannedMessageConfig
#define meshtastic_ModuleConfig_payload_variant_audio_MSGTYPE                  \
  meshtastic_ModuleConfig_AudioConfig
#define meshtastic_ModuleConfig_payload_variant_remote_hardware_MSGTYPE        \
  meshtastic_ModuleConfig_RemoteHardwareConfig
...
#define meshtastic_ModuleConfig_MQTTConfig_fields                              \
  &meshtastic_ModuleConfig_MQTTConfig_msg
#define meshtastic_ModuleConfig_RemoteHardwareConfig_fields                    \
  &meshtastic_ModuleConfig_RemoteHardwareConfig_msg
#define meshtastic_ModuleConfig_AudioConfig_fields                             \
  &meshtastic_ModuleConfig_AudioConfig_msg
#define meshtastic_ModuleConfig_SerialConfig_fields                            \
  &meshtastic_ModuleConfig_SerialConfig_msg
#define meshtastic_ModuleConfig_ExternalNotificationConfig_fields              \
  &meshtastic_ModuleConfig_ExternalNotificationConfig_msg
#define meshtastic_ModuleConfig_StoreForwardConfig_fields                      \
  &meshtastic_ModuleConfig_StoreForwardConfig_msg
#define meshtastic_ModuleConfig_RangeTestConfig_fields                         \
  &meshtastic_ModuleConfig_RangeTestConfig_msg
#define meshtastic_ModuleConfig_TelemetryConfig_fields                         \
  &meshtastic_ModuleConfig_TelemetryConfig_msg
#define meshtastic_ModuleConfig_CannedMessageConfig_fields                     \
  &meshtastic_ModuleConfig_CannedMessageConfig_msg
