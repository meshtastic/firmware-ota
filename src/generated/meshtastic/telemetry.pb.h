...
#define _meshtastic_TelemetrySensorType_MIN                                    \
  meshtastic_TelemetrySensorType_SENSOR_UNSET
#define _meshtastic_TelemetrySensorType_MAX                                    \
...
#define meshtastic_Telemetry_FIELDLIST(X, a)                                   \
  ...
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (variant, device_metrics, variant.device_metrics), 2)                      \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (variant, environment_metrics, variant.environment_metrics), 3)            \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (variant, air_quality_metrics, variant.air_quality_metrics), 4)
#define meshtastic_Telemetry_CALLBACK NULL
#define meshtastic_Telemetry_DEFAULT NULL
#define meshtastic_Telemetry_variant_device_metrics_MSGTYPE                    \
  meshtastic_DeviceMetrics
#define meshtastic_Telemetry_variant_environment_metrics_MSGTYPE               \
  meshtastic_EnvironmentMetrics
#define meshtastic_Telemetry_variant_air_quality_metrics_MSGTYPE               \
  meshtastic_AirQualityMetrics
