...
#define _meshtastic_StoreAndForward_RequestResponse_MIN                        \
  meshtastic_StoreAndForward_RequestResponse_UNSET
#define _meshtastic_StoreAndForward_RequestResponse_MAX                        \
  meshtastic_StoreAndForward_RequestResponse_CLIENT_ABORT
#define _meshtastic_StoreAndForward_RequestResponse_ARRAYSIZE                                             \
  ((meshtastic_StoreAndForward_RequestResponse)(meshtastic_StoreAndForward_RequestResponse_CLIENT_ABORT + \
                                                1))

#define meshtastic_StoreAndForward_rr_ENUMTYPE                                 \
  meshtastic_StoreAndForward_RequestResponse
...
#define meshtastic_StoreAndForward_variant_stats_MSGTYPE                       \
  meshtastic_StoreAndForward_Statistics
#define meshtastic_StoreAndForward_variant_history_MSGTYPE                     \
  meshtastic_StoreAndForward_History
#define meshtastic_StoreAndForward_variant_heartbeat_MSGTYPE                   \
  meshtastic_StoreAndForward_Heartbeat
...
#define meshtastic_StoreAndForward_Statistics_fields                           \
  &meshtastic_StoreAndForward_Statistics_msg
#define meshtastic_StoreAndForward_History_fields                              \
  &meshtastic_StoreAndForward_History_msg
#define meshtastic_StoreAndForward_Heartbeat_fields                            \
  &meshtastic_StoreAndForward_Heartbeat_msg
