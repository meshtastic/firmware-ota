...
#define meshtastic_LocalConfig_init_default                                    \
  {                                                                            \
    false, meshtastic_Config_DeviceConfig_init_default, false,                 \
        meshtastic_Config_PositionConfig_init_default, false,                  \
        meshtastic_Config_PowerConfig_init_default, false,                     \
        meshtastic_Config_NetworkConfig_init_default, false,                   \
        meshtastic_Config_DisplayConfig_init_default, false,                   \
        meshtastic_Config_LoRaConfig_init_default, false,                      \
        meshtastic_Config_BluetoothConfig_init_default, 0                      \
  }
#define meshtastic_LocalModuleConfig_init_default                              \
  {                                                                            \
    false, meshtastic_ModuleConfig_MQTTConfig_init_default, false,             \
        meshtastic_ModuleConfig_SerialConfig_init_default, false,              \
        meshtastic_ModuleConfig_ExternalNotificationConfig_init_default,       \
        false, meshtastic_ModuleConfig_StoreForwardConfig_init_default, false, \
        meshtastic_ModuleConfig_RangeTestConfig_init_default, false,           \
        meshtastic_ModuleConfig_TelemetryConfig_init_default, false,           \
        meshtastic_ModuleConfig_CannedMessageConfig_init_default, 0, false,    \
        meshtastic_ModuleConfig_AudioConfig_init_default, false,               \
        meshtastic_ModuleConfig_RemoteHardwareConfig_init_default              \
  }
#define meshtastic_LocalConfig_init_zero                                       \
  {                                                                            \
    false, meshtastic_Config_DeviceConfig_init_zero, false,                    \
        meshtastic_Config_PositionConfig_init_zero, false,                     \
        meshtastic_Config_PowerConfig_init_zero, false,                        \
        meshtastic_Config_NetworkConfig_init_zero, false,                      \
        meshtastic_Config_DisplayConfig_init_zero, false,                      \
        meshtastic_Config_LoRaConfig_init_zero, false,                         \
        meshtastic_Config_BluetoothConfig_init_zero, 0                         \
  }
#define meshtastic_LocalModuleConfig_init_zero                                 \
  {                                                                            \
    false, meshtastic_ModuleConfig_MQTTConfig_init_zero, false,                \
        meshtastic_ModuleConfig_SerialConfig_init_zero, false,                 \
        meshtastic_ModuleConfig_ExternalNotificationConfig_init_zero, false,   \
        meshtastic_ModuleConfig_StoreForwardConfig_init_zero, false,           \
        meshtastic_ModuleConfig_RangeTestConfig_init_zero, false,              \
        meshtastic_ModuleConfig_TelemetryConfig_init_zero, false,              \
        meshtastic_ModuleConfig_CannedMessageConfig_init_zero, 0, false,       \
        meshtastic_ModuleConfig_AudioConfig_init_zero, false,                  \
...
#define meshtastic_LocalConfig_bluetooth_MSGTYPE                               \
...
#define meshtastic_LocalModuleConfig_mqtt_MSGTYPE                              \
  meshtastic_ModuleConfig_MQTTConfig
#define meshtastic_LocalModuleConfig_serial_MSGTYPE                            \
  meshtastic_ModuleConfig_SerialConfig
#define meshtastic_LocalModuleConfig_external_notification_MSGTYPE             \
  meshtastic_ModuleConfig_ExternalNotificationConfig
#define meshtastic_LocalModuleConfig_store_forward_MSGTYPE                     \
...
#define meshtastic_LocalModuleConfig_telemetry_MSGTYPE                         \
  meshtastic_ModuleConfig_TelemetryConfig
#define meshtastic_LocalModuleConfig_canned_message_MSGTYPE                    \
  meshtastic_ModuleConfig_CannedMessageConfig
#define meshtastic_LocalModuleConfig_audio_MSGTYPE                             \
  meshtastic_ModuleConfig_AudioConfig
#define meshtastic_LocalModuleConfig_remote_hardware_MSGTYPE                   \
